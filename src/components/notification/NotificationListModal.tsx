...
export const NotificationListModal: React.FC<Props> = ({
  ...
  // Logic dich noi dung nam o src/i18n/notificationContent.ts — dung chung voi
  // notificationHandler (luc gui push) de hai noi khong lech nhau.
  const localizeContent = localizeNotificationContent;
